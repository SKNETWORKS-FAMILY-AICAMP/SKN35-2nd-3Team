...
tourist_zone_candidate               bool
population_is_proxied                bool
...
korean_pop                        1889582.0  31711.206460  18547.371561  3464.087606  7121.824826  11904.294276  26533.976667  67917.791977  101051.440314  103190.298593
foreign_long_pop                  1889582.0   1242.434005   1353.723818    52.497705   105.471050    173.114725    762.687818   4287.921983    6596.740771    8514.386657
foreign_short_pop                 1889582.0    916.296312   1969.782899     4.662842    14.841358     26.257768    168.214182   4843.155897    8233.336817   15157.378523
total_pop_avg                     1889582.0  33869.936778  20276.780823  3524.291229  7702.493583  12966.811971  28103.796621  70606.718524  108306.460431  108738.522246
foreign_short_ratio               1889582.0      0.020766      0.037376     0.000495     0.000940      0.001375      0.006594      0.099974       0.166810       0.266943
...
korean_pop                        31640.238731  32306.696715
foreign_long_pop                   1240.213855   1261.063285
foreign_short_pop                   916.894526    911.276699
total_pop_avg                     33797.347113  34479.036698
foreign_short_ratio                   0.020815      0.020354
...
korean_pop                        0.011084
total_pop_avg                     0.010370
lat                              -0.007760
coord_cluster_size               -0.006336
foreign_long_pop                  0.004751
foreign_short_ratio              -0.003807
nearest_same_industry_distance_m -0.003674
lng                              -0.002528
keyword_growth_score              0.001474
foreign_short_pop                -0.000880
total_count_300m                  0.000656
```

## 7. 결측치 패턴 / population_is_proxied 플래그

- 전체 결측치: 0건 (이전 버전에서 있던 gu_name/생활인구 결측이 파이프라인에서 대체값으로 채워짐)

- population_is_proxied=True 행: 30,181건 (1.60%)
- 대상 dong_code 수: 12 -> ['11230515', '11230533', '11305595', '11305603', '11305608', '11305615', '11305625', '11305635', '11530800', '11680675', '11740525', '11740526']

### population_is_proxied별 폐업률

```
                            폐업률
population_is_proxied          
proxied=False          0.106413
proxied=True           0.110931
```
